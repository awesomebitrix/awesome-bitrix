...
В разделе содержатся, сгруппированные по тематическим разделам, официальные курсы по платформе Битрикс, включая тематические и специальные курсы. Курсы, успешное прохождение награждается сертификатом, отмечены :star:
...
## <a id="other">Другое</a>
- [Список онлайн-курсов](http://dev.1c-bitrix.ru/learning/index.php#tab-online-link)
